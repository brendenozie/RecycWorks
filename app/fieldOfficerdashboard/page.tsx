...
import { RapidWeighingSheet } from "./components/RapidWeighingSheet";

type FieldTab = "today-work" | "add-supplier" | "add-load" | "my-suppliers" | "my-loads";

export default function FieldOfficerDashboard() {
  const { user, loading: authLoading, logout } = useAuth();

  const [activeTab, setActiveTab] = useState<FieldTab>("today-work");
  ...
  return (
    <AuthGuard allowedRoles={["field-officer", "field_officer", "operations", "admin"]}>
      ...
      <main className="flex-1 p-4 max-w-lg mx-auto w-full pb-20">
        ...
        {/* ========================================================================= */}
        {/* ========================================================================= */}
        {/* TAB 2: RAPID FIELD WEIGHING SHEET                                        */}
        {/* ========================================================================= */}
        {activeTab === "add-load" && (
          <RapidWeighingSheet
            suppliers={suppliers}
